    ...
    <>
      <footer className="py-10 px-5 sm:px-10 bg-white text-black">
        <div className="max-w-[1200px] mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-8">
            <div>
              <a href="#" className="inline-block no-underline mb-1">
                <img src="/img/logo.png" alt="TELEMO｜AI SALES AUTOMATION" className="h-[44px] sm:h-[52px] w-auto" />
              </a>
              <a
                href=""
                target="_blank"
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 sm:hidden transition-transform duration-300 translate-y-0">
        <div className="bg-white/95 backdrop-blur-sm border-t border-[#e5e5e5] px-4 py-2.5 flex gap-2.5">
          ...
          <a
            href="#contact-form"
            className="flex-1 inline-flex items-center justify-center bg-[#41ac86] text-white text-[12px] font-bold py-3 rounded-[96px] no-underline"
          >
            お問い合わせ
          </a>
        </div>
